<%@ Page Title="" Language="C#" MasterPageFile="~/administrador/modelo.Master"
    AutoEventWireup="true" CodeBehind="modelos.aspx.cs" Inherits="esoEquipamentos26.administrador.modelos" %>
    ...
    <div class="container mt-4">
        <div class="section-card">
            <div class="row mb-3 align-items-center">
                ...
                <label class="col-sm-2 col-form-label text-end">Tipo Equipamento</label>
                <div class="col-sm-4">
                    <asp:DropDownList 
                        ID="listTipoEquipamento" 
                        runat="server" 
                        AutoPostBack="true" 
                        OnSelectedIndexChanged="listTipoEquipamento_SelectedIndexChanged"
                        CssClass="form-select border-secondary">
                    </asp:DropDownList>
                </div>
            </div>
        ...
        <div class="section-card">
            <div class="row mb-4 align-items-center mt-4">
                ...
                <div class="col-sm-10">
                    <asp:GridView runat="server" ID="gridModelos" CssClass="table table-striped table-hover" 
                        EmptyDataText="Não existem modelos para os filtros selecionados."
                        OnRowDataBound="gridModelos_RowDataBound" 
                        OnSelectedIndexChanged="gridModelos_SelectedIndexChanged"
            ...
            <div class="row my-4 align-items-center">
                ...
                <div class="col-sm-10">
                    ...
                    <asp:Button Text="Criar modelo" runat="server" CssClass="btn btn-primary ms-4" ID="buttonCriar" OnClick="buttonCriar_Click" />
        ...
        <div id="formularioDados" runat="server" visible="false">
            <div class="section-card">
                <h5 class="section-title">📋 Informações do Modelo</h5>
                ...
                <div class="row mb-3">
                    ...
                    <label class="col-sm-2 col-form-label text-end">Tipo Equipamento</label>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="ddlTipoEquipamento" runat="server" CssClass="form-select" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <asp:TextBox ID="txtDescricao" runat="server" TextMode="MultiLine" Rows="4" CssClass="form-control" />
                    </div>
                </div>
            </div>

            <div class="section-card">
                <h5 class="section-title">🔗 URLs e Recursos</h5>
