<%@ Page Title="" Language="C#" MasterPageFile="~/administrador/modelo.Master"
    AutoEventWireup="true" CodeBehind="computadoresDesktop.aspx.cs" Inherits="esoEquipamentos26.administrador.computadoresDesktop" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-4">
        ...
        <div id="formularioDados" runat="server" visible="false">
            ...
            <div class="section-card">
                <h5 class="section-title">Especifica&ccedil;&otilde;es de Hardware</h5>
                
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-end">Caixa</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtCaixa" runat="server" CssClass="form-control" />
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <label class="col-sm-2 col-form-label text-end">Placa Gr&aacute;fica</label>
                    <div class="col-sm-4">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-end">Fonte Alimenta&ccedil;&atilde;o</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtFonteAlimentacao" runat="server" CssClass="form-control" />
                    </div>
            ...
            <div class="section-card">
                ...
                <div class="row mb-3">
                    ...
                    <label class="col-sm-2 col-form-label text-end">Porta VGA</label>
                    <div class="col-sm-2 d-flex align-items-center">
                        <asp:CheckBox ID="chkPortaVGA" runat="server" CssClass="form-check-input" />
                    </div>
                </div>

                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-end">DisplayPort</label>
                    <div class="col-sm-2 d-flex align-items-center">
                        <asp:CheckBox ID="chkDisplayPort" runat="server" CssClass="form-check-input" />
                    </div>
                    <label class="col-sm-2 col-form-label text-end">Porta Ethernet</label>
                    <div class="col-sm-2 d-flex align-items-center">
                        <asp:CheckBox ID="chkPortaEthernet" runat="server" CssClass="form-check-input" />
                    </div>
