<%@ Page Title="" Language="C#" MasterPageFile="~/administrador/modelo.Master" AutoEventWireup="true" CodeBehind="videoprojetor.aspx.cs" Inherits="esoEquipamentos26.administrador.videoprojetor" ResponseEncoding="utf-8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="main-header">
            <h1 class="mb-0">Videoprojectores</h1>
        </div>
    </div>
    ...
    <div class="container mt-4">
        <div class="section-card">
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <asp:DropDownList ID="listMarca" runat="server" AutoPostBack="true" OnSelectedIndexChanged="listMarca_SelectedIndexChanged" CssClass="form-select border-secondary w-50"></asp:DropDownList>
                </div>
            </div>
        </div>
        ...
        <div class="section-card">
            <div class="row mb-4 align-items-center mt-4">
                ...
                <div class="col-sm-10">
                    <asp:GridView runat="server" ID="gridVideoprojectores" CssClass="table table-striped table-hover" EmptyDataText="Não existem videoprojectores" OnSelectedIndexChanged="gridVideoprojectores_SelectedIndexChanged" DataKeyNames="IDModelo" AutoGenerateColumns="false">
                        <Columns>
            ...
            <div class="row my-4 align-items-center">
                ...
                <div class="col-sm-10">
                    ...
                    <asp:Button Text="Criar" runat="server" CssClass="btn btn-primary ms-4" ID="buttonCriar" OnClick="buttonCriar_Click" />
        ...
        <div id="formularioDados" runat="server" Visible="false">
            ...
            <div class="section-card">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-end">Luminosidade</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtLuminosidade" runat="server" CssClass="form-control" />
                    </div>
                    <label class="col-sm-2 col-form-label text-end">Resolu&ccedil;&atilde;o Nativa</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtResolucaoNativa" runat="server" CssClass="form-control" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtHDMIPortas" runat="server" CssClass="form-control" TextMode="Number" />
                    </div>
                    <label class="col-sm-2 col-form-label text-end">Portas USB</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtUSBPortas" runat="server" CssClass="form-control" TextMode="Number" />
                    </div>
                </div>

                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-end">Full HD</label>
                    <div class="col-sm-2 d-flex align-items-center">
                        <asp:CheckBox ID="chkFullHD" runat="server" CssClass="form-check-input" />
                    </div>
                    <label class="col-sm-2 col-form-label text-end">Wi-Fi</label>
                    <div class="col-sm-2 d-flex align-items-center">
                        <asp:CheckBox ID="chkWifi" runat="server" CssClass="form-check-input" />
                    </div>
                    <label class="col-sm-2 col-form-label text-end">Altifalantes</label>
                    <div class="col-sm-2 d-flex align-items-center">
                        <asp:CheckBox ID="chkAltifalantes" runat="server" CssClass="form-check-input" />
                    </div>
                </div>
            </div>
